...
This command allows users to view their notifications on Twitter in their android devices. Ensure the user is already logged into Twitter Application before using this command.
...
2. The robot then guides the user to the application interface and then shows the notifications.
## Example

This simple script opens twitter application and views the notification to its users. The Robot will then keep the user updated with what is happening around him with his followers.
