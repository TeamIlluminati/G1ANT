# twitterandroid.createlists

## Syntax

```G1ANT
twitterandroid.createlists name ⟦text⟧ description ⟦text⟧
```

## Description

This command allows the user to create a list on Twitter. Ensure that the User is already logged in with Twitter when carrying out the process. 

| Argument | Type | Required | Default Value | Description |
| -------- | ---- | -------- | ------------- | ----------- |
|`name`| [text](https://manual.g1ant.com/link/G1ANT.Language/G1ANT.Language/Structures/TextStructure.md) | yes |  | Name of the list |
|`description`| [text](https://manual.g1ant.com/link/G1ANT.Language/G1ANT.Language/Structures/TextStructure.md) | yes |  | One line about the list to notify users |
...
2. After successful login, the robot will guide the user to create his own list with the description and can then later share the same with his friends using other options. 
...
twitterandroid.open 
delay 5
twitterandroid.createlists name ‴Lists‴ description ‴General List for storing items‴ 
```
