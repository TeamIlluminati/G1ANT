...
```G1ANT
twitterandroid.search name ⟦text⟧ 
```

## Description

This command allows the user to search people or topics on Twitter. Ensure that the User is already logged in with Twitter when carrying out the process. 

| Argument | Type | Required | Default Value | Description |
| -------- | ---- | -------- | ------------- | ----------- |
|`name`| [text](https://manual.g1ant.com/link/G1ANT.Language/G1ANT.Language/Structures/TextStructure.md) | yes |  | Name of the person or topic to be searched |
...
2. After successful login, the robot will guide the user to search for people or topics to follow on Twitter. Based on the topic of selection, the robot will appropriately display the results to the user for his selection. 
## Example

This simple script allows users to search for topics or tweets on Twitter with G1ANT Studio. 

```G1ANT
dialog ‴Twitter Android Features with G1ANT Studio‴
twitterandroid.open 
delay 5
twitterandroid.search name ‴Trending‴ 
delay 5
