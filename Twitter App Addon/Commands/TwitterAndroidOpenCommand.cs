...
{
    [Command(Name = "twitterandroid.open", Tooltip = "This command initialises appium server and open Twitter in android application instance.")]
    public class TwitterAndroidOpenCommand : Language.Command 
    {
        ...
        public class Arguments : CommandArguments
        {
            ...
            public TextStructure AppActivity { get; set; } = new TextStructure("com.twitter.android.StartActivity");
        ...
        public TwitterAndroidOpenCommand(AbstractScripter scripter) : base(scripter)
        {
        }
