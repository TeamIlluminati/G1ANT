...
{
    [Command(Name = "zomatoapp.notifications", Tooltip = "This command will open payments option on Zomato App")]
    public class ZomatoAppPaymentsCommand : Language.Command
    {
        ...
        public ZomatoAppPaymentsCommand(AbstractScripter scripter) : base(scripter)
        {
