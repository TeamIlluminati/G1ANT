...
{
    [Command(Name = "zomatoapp.notifications", Tooltip = "This command will open notifications on Zomato App")]
    public class ZomatoAppNotificationsCommand : Language.Command
    {
        ...
        public ZomatoAppNotificationsCommand(AbstractScripter scripter) : base(scripter)
        {
