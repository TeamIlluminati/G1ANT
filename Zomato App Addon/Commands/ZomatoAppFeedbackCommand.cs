...
{
    [Command(Name = "zomatoapp.feedback", Tooltip = "This command will open feedback option on Zomato App")]
    public class ZomatoAppFeedbackCommand : Language.Command
    {
        ...
        public ZomatoAppFeedbackCommand(AbstractScripter scripter) : base(scripter)
        {
