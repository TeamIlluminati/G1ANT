...
{
    [Command(Name = "zomatoapp.profile", Tooltip = "This command will open settings on Zomato App")]
    public class ZomatoAppSettingsCommand : Language.Command
    {
        ...
        public ZomatoAppSettingsCommand(AbstractScripter scripter) : base(scripter)
        {
