...
```G1ANT
zomatoapp.open devicename ⟦text⟧ platformname ⟦text⟧ platformversion ⟦text⟧
```

## Description

This command open zomato app in Android.
...
This simple script opens a zomato application in user's android device.
