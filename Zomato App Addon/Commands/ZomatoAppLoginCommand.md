...
```G1ANT
zomatoapp.login email ⟦text⟧ pword ⟦text⟧
```

## Description

This command logins the user into zomato app.
...
This simple script opens a zomato application and then logs into the account with provided credentials in app.

```G1ANT
zomatoapp.open
delay 8
zomatoapp.login email <Enter your email here> pword <Enter your password>
```
