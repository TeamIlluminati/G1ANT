...
{
    [Command(Name = "zomatoapp.open", Tooltip = "This command will open Zomato App.")]
    public class ZomatoAppOpenCommand : Language.Command
    {
        ...
        public class Arguments : CommandArguments
        {
            ...
            [Argument(DefaultVariable = "app activity", Tooltip = "App Package")]
        ...
        public ZomatoAppOpenCommand(AbstractScripter scripter) : base(scripter)
        {
        }
