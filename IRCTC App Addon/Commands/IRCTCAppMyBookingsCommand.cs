...
{
    [Command(Name = "irctcapp.mybookings", Tooltip = "This command displays user's bookings in IRCTC app. Make sure that you are signed in into the app")]

    public class IRCTCAppMyBookingsCommand : Language.Command
    {
        public IRCTCAppMyBookingsCommand(AbstractScripter scripter) : base(scripter)
        {
