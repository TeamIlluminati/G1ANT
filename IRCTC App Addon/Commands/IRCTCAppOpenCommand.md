...
```G1ANT
irctcapp.open devicename ⟦text⟧ platformname ⟦text⟧ platformversion ⟦text⟧
```

## Description

This command open IRCTC app in user's Android device.
...
This simple script opens a IRCTC application in user's android device.
