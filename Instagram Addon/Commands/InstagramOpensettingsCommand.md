...
This command is used to open settings on instagram.
...
This simple script opens instagram and login with the credential which user will give and open settings in instagram.
