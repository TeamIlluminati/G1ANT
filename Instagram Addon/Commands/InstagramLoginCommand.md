...
This command will sign-in user into instagram website.
...
This simple script logins the user in instagram website.

```G1ANT
instagram.open Type ‴chrome‴ 
delay 10
instagram.login email <Enter your email address here> pword <Enter your password here>
```
