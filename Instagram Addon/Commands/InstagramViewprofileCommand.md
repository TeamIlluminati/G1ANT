...
This command is used to view profile on instagram.
...
This simple script opens instagram and login with the credential which user will give and view profile in instagram.
