...
This command helps you to show user account on Amazon app
...
This simple script opens a amazon application and then logs into the account with provided credentials in app and then display user's account in it.
