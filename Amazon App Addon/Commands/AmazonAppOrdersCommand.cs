...
{
    [Command(Name = "amazonapp.orders", Tooltip = "This command will view your orders")]
    public class AmazonAppOrdersCommand : Language.Command
    {
        ...
        public AmazonAppOrdersCommand(AbstractScripter scripter) : base(scripter)
        {
