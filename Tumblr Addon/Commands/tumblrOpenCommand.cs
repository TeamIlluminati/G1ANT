...
{
    [Command(Name = "tumblr.open", Tooltip = "This command opens a new instance of a chosen web browser and navigates to tumblr")]
    public class tumblrOpenCommand : Command
    {
        public const string url = "www.tumblr.com";
        public class Arguments : CommandArguments
        {
            [Argument(Required = true, Tooltip = "Name of a web browser")]
            public TextStructure Type { get; set; }

            [Argument(Tooltip = "tumblr home page gets loaded")]
        ...
        public tumblrOpenCommand(AbstractScripter scripter) : base(scripter)
        {
        }
