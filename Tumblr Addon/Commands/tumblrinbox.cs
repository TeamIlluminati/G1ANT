...
{
    [Command(Name = "tumblr.inbox", Tooltip = "This command sign-in user into tumblr")]

    class tumblrseemessagesCommand : Command
    {
        public tumblrseemessagesCommand(AbstractScripter scripter) : base(scripter)
        {
        ...
        public void Execute(Arguments arguments)
        {
            try
            {
                ...
                arguments.Search.Value = "/html/body/div[3]/div/div[1]/div/div[3]/a";
