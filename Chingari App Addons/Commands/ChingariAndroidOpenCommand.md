...
This command opens Chingari in user's android device.
...
This simple script opens chingari application in android devices. 

```G1ANT
mycommand message ‴Hi, testing G1ANT without using the tick‴ 
chingariandroid.open
delay 5
