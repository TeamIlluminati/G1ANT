# quoraandroid.searchmusic

## Syntax

```G1ANT
quoraandroid.searchtags search ⟦text⟧
```

## Description

This command allows the user to search for any videos with hashtags in Chingari

| Argument | Type | Required | Default Value | Description |
| -------- | ---- | -------- | ------------- | ----------- |
|`search`| [text](https://manual.g1ant.com/link/G1ANT.Language/G1ANT.Language/Structures/TextStructure.md) | yes |  | Hashtag to be searched |
...
2. The required hashtag will be searched and shared with the user 

## Example

This simple script opens Chingari and searches for a particular hashtag in Chingari. 
