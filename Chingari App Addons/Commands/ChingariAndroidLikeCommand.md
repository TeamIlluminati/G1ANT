...
This command selects the heart option (like) to the videos
...
> **Note:** Videos keep changing. Hence the like option need not be accurate
## Example

This simple script opens Chingari in android phones, then heading to the GIF section and likes the videos. 
