...
{
    [Command(Name = "chingariandroid.open", Tooltip = "This command initialises appium server and opens Chingari in android application instance.")]
    public class ChingariAndroidOpenCommand : Language.Command
    {
        ...
        public class Arguments : CommandArguments
        {
            ...
            public TextStructure AppActivity { get; set; } = new TextStructure("io.chingari.app.Activity.SplashActivity");
