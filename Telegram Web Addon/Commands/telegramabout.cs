...
{
    [Command(Name = "telegram.about", Tooltip = "This command opens about page of telegram")]
    public class telegramaboutCommand : Command
    {
        ...
        public telegramaboutCommand(AbstractScripter scripter) : base(scripter)
        {
        }
        public void Execute(Arguments arguments)
        {
            try
            {
                ...
                arguments.Search.Value = "/html/body/div[1]/div[1]/div/div/div[1]/div/ul/li[5]/a";
                arguments.By.Value = "xpath";
                SeleniumManager.CurrentWrapper.Click(arguments, arguments.Timeout.Value, arguments.WaitForNewWindow.Value);
            }
            catch (Exception ex)
