...
{
    [Command(Name = "telegram.contacts", Tooltip = "This command opens your contacts")]
    public class telegramcontactsCommand : Command
    {
        ...
        public telegramcontactsCommand(AbstractScripter scripter) : base(scripter)
        {
        }
        public void Execute(Arguments arguments)
        {
            try
            {
                ...
                arguments.Search.Value = "/html/body/div[1]/div[1]/div/div/div[1]/div/ul/li[2]/a";
                arguments.By.Value = "xpath";
                SeleniumManager.CurrentWrapper.Click(arguments, arguments.Timeout.Value, arguments.WaitForNewWindow.Value);
            }
            catch (Exception ex)
