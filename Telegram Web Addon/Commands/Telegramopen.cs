...
{
    [Command(Name = "telegram.open", Tooltip = "This command opens telegram web page")]
    public class TelegramOpenCommand : Command
    {
        public const string url = "https://web.telegram.org/#/im";
        ...
        public TelegramOpenCommand(AbstractScripter scripter) : base(scripter)
        {
        }
