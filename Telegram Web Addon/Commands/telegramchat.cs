...
{
    [Command(Name = "telegram.chat", Tooltip = "This command type the message you want to chat with your friend")]
    public class telegramchatCommand : Command
    {
        public class Arguments : SeleniumCommandArguments
        {
            ...
            [Argument(Required = true, Tooltip = "Enter the trend to be opened")]
            public TextStructure chat { get; set; } = new TextStructure();
        }
        public telegramchatCommand(AbstractScripter scripter) : base(scripter)
        {
        }
        public void Execute(Arguments arguments)
        {
            try
            {
                ...
                arguments.By.Value = "xpath";
                SeleniumManager.CurrentWrapper.Click(arguments, arguments.Timeout.Value, arguments.WaitForNewWindow.Value);
                arguments.Search.Value = "/html/body/div[1]/div[2]/div/div[2]/div[3]/div/div[3]/div[2]/div/div/div/form/div[2]/div[5]";
                arguments.By.Value = "xpath";
                SeleniumManager.CurrentWrapper.Click(arguments, arguments.Timeout.Value, arguments.WaitForNewWindow.Value);
                SeleniumManager.CurrentWrapper.TypeText(arguments.chat.Value, arguments, arguments.Timeout.Value);
                SeleniumManager.CurrentWrapper.PressKey("enter", arguments, arguments.Timeout.Value);
