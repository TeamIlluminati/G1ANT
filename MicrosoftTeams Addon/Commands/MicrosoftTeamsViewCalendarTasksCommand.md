...
This command allows the User to check their Calendar tasks on MicrosoftTeams. Ensure that the user is first logged in with appropriate userid and password
...
2. Once logged in, after successful authentication, the robot performs the task of checking the calendar tasks and then ensure the user of any upcoming tasks of any meetings or sessions.
3. After completion, the robot then signs out of the web browser.

## Example

This script opens MicrosoftTeams in Chrome browser and logs into Teams. It then checks for any calendar tasks and intimates the user for any meetings
