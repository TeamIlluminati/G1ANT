...
This command allows the User to check their feeds on MicrosoftTeams. Ensure that the user is first logged in with appropriate userid and password
...
2. Once logged in, after successful authentication, the robot performs the task of checking the feeds and inform what is around.
3. After completion, the robot then signs out of the web browser.

## Example

This script opens MicrosoftTeams in Chrome browser and logs into Teams. It then opens the users feed and produces general details
