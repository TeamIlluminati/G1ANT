...
This command allows the User to sign out from MicrosoftTeams after performing all the tasks. Ensure that the user is first logged in with appropriate userid and password
...
2. Once logged in, after successful authentication, the robot performs a range of tasks assigned by the user.
3. After completion, the robot then signs out of the web browser.

## Example

This script opens MicrosoftTeams in Chrome browser and logs into Teams. After 5 seconds, the robot then signs out of MicrosoftTeams. 
