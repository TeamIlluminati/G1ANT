...
{
    [Command(Name = "chinagri.open",Tooltip = "Opens the website")]
    class ChinagriWebOpenCommand : Command
    {
        public ChinagriWebOpenCommand(AbstractScripter scripter): base(scripter)
        {
