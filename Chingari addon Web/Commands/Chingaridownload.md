...
This command ensures that Chingari is downloaded in an android phone.
...
This simple script opens chingari in chrome browser and then waits for 5 seconds. The robot then downloads the chingari application from playstore to an android phone.
