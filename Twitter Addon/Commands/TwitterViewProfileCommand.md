...
This command allows the user to view users profile on Twitter. Ensure that the user is first logged into twitter and then execute the posting process. 
...
2. Once the authentication is successfully approved, the robot then guides the user to view their profile on Twitter 
## Example

This simple script demonstrates how the Users profile can be viewed on twitter with the help of G1ANT studio.
```G1ANT
