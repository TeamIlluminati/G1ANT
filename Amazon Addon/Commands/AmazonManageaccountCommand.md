...
This command shows user's account on amazon
...
This simple script logins the user in amazon website and then display user's account

```G1ANT
amazon.open Type ‴chrome‴ 
delay 10
amazon.login phoneno ‴test@gmail.com‴ pword ‴passwordtest‴
delay 5
amazon.manageaccount
```
