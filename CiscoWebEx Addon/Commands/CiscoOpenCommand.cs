...
{
    [Command(Name = "ciscoweb.open", Tooltip = "Opens the defined webpage for the user")]
    class CiscoOpenCommand : Command
    {
        public CiscoOpenCommand(AbstractScripter scripter): base(scripter)
        {
        ...
        public class Arguments : CiscoWebExCommandArguments
        {
            ...
            public TextStructure Url { get; set; } = new TextStructure("https://www.webex.com/");
