...
This command allows user to view information about the meetings on WebEx 
...
3. The user will then be hinted on what meetings have been conducted and given details on the same. 

## Example

This script opens WebEx, guides the user to the portal and then view information about the meetings that have taken place
```G1ANT
ciscowebex.open 
delay 5
