...
This command allows user to view the upcoming meetings on WebEx
...
3. The robot then guides the user and shows the upcoming meetings.

## Example

This script opens WebEx, guides the user to teams and logs in with the credential which the user gives and gives an idea on the upcoming meetings. 
```G1ANT
ciscowebex.open 
delay 5
