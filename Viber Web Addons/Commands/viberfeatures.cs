...
{
    [Command(Name = "viber.features", Tooltip = "This command opens features page")]
    public class viberfeaturesCommand : Command
    {
        ...
        public viberfeaturesCommand(AbstractScripter scripter) : base(scripter)
        {
        }
        public void Execute(Arguments arguments)
        {
            try
            {
                arguments.Search.Value = "/html/body/div/div/main/div[2]/div/div/div/div[3]/a";
