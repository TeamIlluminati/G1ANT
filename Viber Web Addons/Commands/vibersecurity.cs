...
{
    [Command(Name = "viber.security", Tooltip = "This command security page")]
    public class vibersecurityCommand : Command
    {
        ...
        public vibersecurityCommand(AbstractScripter scripter) : base(scripter)
        {
        }
        public void Execute(Arguments arguments)
        {
            try
            {
                arguments.Search.Value = "/html/body/div/div/main/div[4]/div/div/div[1]/a";
