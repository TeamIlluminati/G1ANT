...
{
    [Command(Name = "viber.support", Tooltip = "This command opens support page")]
    public class vibersupportCommand : Command
    {
        ...
        public vibersupportCommand(AbstractScripter scripter) : base(scripter)
        {
        }
        public void Execute(Arguments arguments)
        {
            try
            {
                arguments.Search.Value = "/html/body/footer/div[1]/div/div/section[1]/div/ul/li[7]/a";
