...
```G1ANT
youtubeapp.open devicename ⟦text⟧ platformname ⟦text⟧ platformversion ⟦text⟧
```

## Description

This command open youtube app in Android.
...
This simple script opens a Youtube application in user's android device.
