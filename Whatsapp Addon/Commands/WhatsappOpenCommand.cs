...
namespace G1ANT.Addon.Whatsapp
{
    ...
    [Command(Name = "whatsapp.open", Tooltip = "This command will open whatsapp")]
    class WhatsappOpenCommand : Command
    {
        public WhatsappOpenCommand(AbstractScripter scripter) : base(scripter)
        {
