...
{
    [Command(Name = "whatsapp.viewprofile", Tooltip = "This command will view your profile on whatsapp")]
    class WhatsappViewprofileCommand : Command
    {
        public WhatsappViewprofileCommand(AbstractScripter scripter) : base(scripter)
        {
