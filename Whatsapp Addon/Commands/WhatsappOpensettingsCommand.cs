...
{
    [Command(Name = "whatsapp.opensetting", Tooltip = "This command will open settings on whatsapp")]
    class WhatsappOpensettingsCommand : Command
    {
        public WhatsappOpensettingsCommand(AbstractScripter scripter) : base(scripter)
        {
