...
{
    [Command(Name = "rapido.blog", Tooltip = "This command opens the blog page of rapido")]
    public class RapidoblogCommand : Command
    {
        ...
        public RapidoblogCommand(AbstractScripter scripter) : base(scripter)
        {
        }
        public void Execute(Arguments arguments)
        {
            try
            {
                ...
                arguments.Search.Value = "/html/body/div/div/section[1]/div/div/div[4]/a[4]";
                arguments.By.Value = "xpath";
                SeleniumManager.CurrentWrapper.Click(arguments, arguments.Timeout.Value, arguments.WaitForNewWindow.Value);
            }
