...
{
    [Command(Name = "rapido.contact", Tooltip = "This command opens the contact page of rapido")]
    public class RapidocontactCommand : Command
    {
        ...
        public RapidocontactCommand(AbstractScripter scripter) : base(scripter)
        {
        }
        public void Execute(Arguments arguments)
        {
            try
            {
                arguments.Search.Value = "/html/body/div/div/section[1]/div/div/div[3]/div";
                arguments.By.Value = "xpath";
                SeleniumManager.CurrentWrapper.Click(arguments, arguments.Timeout.Value, arguments.WaitForNewWindow.Value);
                arguments.Search.Value = "/html/body/div/div/section[1]/div/div/div[4]/a[10]";
                arguments.By.Value = "xpath";
                SeleniumManager.CurrentWrapper.Click(arguments, arguments.Timeout.Value, arguments.WaitForNewWindow.Value);
            }
