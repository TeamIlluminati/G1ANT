...
{
    [Command(Name = "rapido.open", Tooltip = "This command opens a new instance of a chosen web browser and opens the rapido home page")]
    public class RapidoOpenCommand : Command
    {
        public const string url = "https://rapido.bike/";
        ...
        public RapidoOpenCommand(AbstractScripter scripter) : base(scripter)
        {
        }
