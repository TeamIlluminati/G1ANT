...
{
    [Command(Name = "rapido.about", Tooltip = "This command opens the about us page of rapido")]
    public class RapidoaboutusCommand : Command
    {
        ...
        public RapidoaboutusCommand(AbstractScripter scripter) : base(scripter)
        {
        }
