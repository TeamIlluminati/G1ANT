# quoraandroid.askquestions

## Syntax

```G1ANT
quoraandroid.askquestions askquestions ⟦text⟧
```

## Description

This command allows the user to ask questions for any topic of interest in Quora.

| Argument | Type | Required | Default Value | Description |
| -------- | ---- | -------- | ------------- | ----------- |
|`question`| [text](https://manual.g1ant.com/link/G1ANT.Language/G1ANT.Language/Structures/TextStructure.md) | no |  | Query to be asked |
...
1. The user will be logged in to Quora and then wait for 5 seconds.
2. The question requested by the user will then be posted online

## Example

This script first opens Quora in the android phone and wait for 5 seconds. The robot will then post the question online in the common platform. 

```G1ANT
dialog message ‴Testing out Quora in android‴
quoraandroid.open
delay 5
quoraandroid.askquestions question ‴Why are appples red?‴
```
