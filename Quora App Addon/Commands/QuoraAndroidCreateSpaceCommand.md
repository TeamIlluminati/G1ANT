# quoraandroid.createspace

## Syntax

```G1ANT
quoraandroid.createspace name ⟦text⟧ space ⟦text⟧
```

## Description

This command allows the user to create a space on Quora

| Argument | Type | Required | Default Value | Description |
| -------- | ---- | -------- | ------------- | ----------- |
|`name`| [text](https://manual.g1ant.com/link/G1ANT.Language/G1ANT.Language/Structures/TextStructure.md) | yes |  | Name of the space |
|`space`| [text](https://manual.g1ant.com/link/G1ANT.Language/G1ANT.Language/Structures/TextStructure.md) | yes |  | One line about the space |
...
2. The user will be viewing his profile.
3. The user will be then making a space to keep his or her personal content

## Example

This simple script allows users to create spaces on Quora 
...
delay 2 
quoraandroid.createspace name ‴Mine‴ space ‴Personal space‴  
