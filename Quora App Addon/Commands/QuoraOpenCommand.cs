...
{
    [Command(Name = "quoraandroid.open", Tooltip = "This command initialises appium server and open Quora in android application instance.")]
    public class QuoraOpenCommand : Language.Command 
    {
        ...
        public QuoraOpenCommand(AbstractScripter scripter) : base(scripter)
        {
        }
