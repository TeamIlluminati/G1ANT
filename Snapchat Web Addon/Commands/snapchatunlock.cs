...
{
    [Command(Name = "snapchat.unlock", Tooltip = "This command unlocks your account")]
    public class SnapchatunlockCommand : Command
    {
        ...
        public SnapchatunlockCommand(AbstractScripter scripter) : base(scripter)
        {
        }
        public void Execute(Arguments arguments)
        {
            try
            {
                arguments.Search.Value = "/html/body/div[2]/div[2]/div/div/div/p[7]/a";
