...
{
    [Command(Name = "snapchat.open", Tooltip = "This command opens snapchat home page")]
    public class SnapchatOpenCommand : Command
    {
        public const string url = "https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fwelcome";
        ...
        public SnapchatOpenCommand(AbstractScripter scripter) : base(scripter)
        {
        }
