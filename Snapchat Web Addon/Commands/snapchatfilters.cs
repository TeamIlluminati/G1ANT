...
{
    [Command(Name = "snapchat.filters", Tooltip = "This command opens filters page")]
    public class SnapchatfiltersCommand : Command
    {
        ...
        public SnapchatfiltersCommand(AbstractScripter scripter) : base(scripter)
        {
        }
        public void Execute(Arguments arguments)
        {
            try
            {
                arguments.Search.Value = "/html/body/div[2]/div[2]/div/div/div/p[5]/a";
