...
{
    [Command(Name = "snapchat.manageapps", Tooltip = "This command opens manage apps page")]
    public class SnapchatmanageappsCommand : Command
    {
        ...
        public SnapchatmanageappsCommand(AbstractScripter scripter) : base(scripter)
        {
        }
        public void Execute(Arguments arguments)
        {
            try
            {
                arguments.Search.Value = "/html/body/div[2]/div[2]/div/div/div/p[9]/a";
