...
{
    [Command(Name = "snapchat.data", Tooltip = "This command opens data page")]
    public class SnapchatdataCommand : Command
    {
        ...
        public SnapchatdataCommand(AbstractScripter scripter) : base(scripter)
        {
        }
        public void Execute(Arguments arguments)
        {
            try
            {
                arguments.Search.Value = "/html/body/div[2]/div[2]/div/div/div/p[3]/a";
