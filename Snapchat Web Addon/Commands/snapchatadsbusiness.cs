...
{
    [Command(Name = "snapchat.business", Tooltip = "This command opens business page")]
    public class Snapchatbusinesscommand : Command
    {
        ...
        public Snapchatbusinesscommand(AbstractScripter scripter) : base(scripter)
        {
        }
        public void Execute(Arguments arguments)
        {
            try
            {
                arguments.Search.Value = "/html/body/div[2]/div[2]/div/div/div/p[4]/a";
