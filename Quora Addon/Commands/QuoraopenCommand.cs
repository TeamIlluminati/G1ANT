...
{
    [Command(Name = "quora.open", Tooltip = "This is to open the webpage")]
    class QuoraopenCommand : Command
    {
        ...
        public class Arguments : CommandArguments
        {
            ...
            public TextStructure Url { get; set; } = new TextStructure("www.quora.com");
