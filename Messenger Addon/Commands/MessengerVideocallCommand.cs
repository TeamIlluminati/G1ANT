...
{
    [Command(Name = "messenger.videocall", Tooltip = "You can Video call a recipient on Messenger using this command")]
    class MessengerVideocallCommand : Command
    {
        public MessengerVideocallCommand(AbstractScripter scripter) : base(scripter)
        {
        ...
        public void Execute(Arguments arguments)
        {
            try
            {
                ...
                arguments.Search.Value = "/html/body/div[1]/div/div/div[2]/span/div[1]/ul/li[2]/a";
                arguments.By.Value = "xpath";
                SeleniumManager.CurrentWrapper.Click(arguments, arguments.Timeout.Value);
