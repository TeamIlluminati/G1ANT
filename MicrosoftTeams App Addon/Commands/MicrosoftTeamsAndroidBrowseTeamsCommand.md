# microsoftteamsandroid.browseteams
...
This command allows the user to browse teams on Microsoft Teams. Ensure the user is logged into Teams before executing this command. 
...
2. After Successful authentication, the robot guides the user to where he can note on the teams he is present. 

## Example

This simple script demonstrates how browsing teams can be done on Microsoft Teams with G1ANT Studio. 
