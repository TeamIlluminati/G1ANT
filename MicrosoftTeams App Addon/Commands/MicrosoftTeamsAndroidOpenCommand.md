...
This command opens Microsoft Teams in user's android device.
...
With the android device being connected and configured, based on the app activity and app package defined, Microsoft Teams opens on the user's device and would be ready for using in phone. 

## Example

This simple script opens Microsoft Teams Application in android devices. 
