...
{
    [Command(Name = "microsoftteamsandroid.open", Tooltip = "This command initialises appium server and opens Microsoft Teams in android application instance.")]
    public class MicrosoftTeamsAndroidOpenCommand : Language.Command
    {
        ...
        public class Arguments : CommandArguments
        {
            ...
            public TextStructure AppPackage { get; set; } = new TextStructure("com.microsoft.teams");

            [Argument(DefaultVariable = "app activity", Tooltip = "App Activity")]
            public TextStructure AppActivity { get; set; } = new TextStructure("com.microsoft.skype.teams.Launcher");
        ...
        public MicrosoftTeamsAndroidOpenCommand(AbstractScripter scripter) : base(scripter)
        {
        }
