...
```G1ANT
instagramapp.open devicename ⟦text⟧ platformname ⟦text⟧ platformversion ⟦text⟧
```

## Description

This command open instagram app in Android.
...
This simple script opens a instagram application in user's android device.
