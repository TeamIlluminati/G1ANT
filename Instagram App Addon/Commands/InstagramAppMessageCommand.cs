...
{
    [Command(Name = "instagramapp.message", Tooltip = "This command opens your profile settings")]
    public class InstagramAppMessageCommand : Language.Command
    {
        ...
        {
            arguments.Search.Value = "//android.widget.ImageView[@content-desc='Message']";
