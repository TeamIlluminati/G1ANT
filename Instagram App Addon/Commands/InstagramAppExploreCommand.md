...
This command displays Explore section in instagram app 
...
This simple script opens a instagram application in user's android device and then open explore section in instagram app.
