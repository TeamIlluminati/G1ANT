...
This command displays settings in instagram app 
...
This simple script opens a instagram application in user's android device and then open settings section in instagram app.
