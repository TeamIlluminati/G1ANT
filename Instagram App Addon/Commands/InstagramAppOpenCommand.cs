...
{
    [Command(Name = "instagramapp.open", Tooltip = "This command will open Instagram App.")]
    public class OpenCommand : Language.Command
    {
        ...
        public class Arguments : CommandArguments
        {
            ...
            public TextStructure AppActivity { get; set; } = new TextStructure("com.instagram.mainactivity.MainActivity");

            [Argument(DefaultVariable = "app package", Tooltip = "App Package")]
            public TextStructure AppPackage { get; set; } = new TextStructure("com.instagram.android");
