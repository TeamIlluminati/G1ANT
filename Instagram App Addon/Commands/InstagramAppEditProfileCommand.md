...
This command will open edit profile page in instagram app 
...
This simple script opens a instagram application in user's android device and then open edit profile section in instagram app.
