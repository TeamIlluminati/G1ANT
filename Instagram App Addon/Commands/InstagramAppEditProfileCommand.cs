...
{
    [Command(Name = "instagramapp.profedit", Tooltip = "This command will open edit profile options")]
    public class InstagramAppEditProfileCommand : Language.Command
    {
        ...
        public InstagramAppEditProfileCommand(AbstractScripter scripter) : base(scripter)
        {
