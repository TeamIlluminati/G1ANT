...
This command displays inbox message section in instagram app 
...
This simple script opens a instagram application in user's android device and then open message inbox section in instagram app.
