...
This command displays App Activity in instagram app 
...
This simple script opens a instagram application in user's android device and then open App Activity section in instagram app.
