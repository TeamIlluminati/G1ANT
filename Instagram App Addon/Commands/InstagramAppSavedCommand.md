...
This command displays Saved section in instagram app 
...
This simple script opens a instagram application in user's android device and then open saved section in instagram app.
