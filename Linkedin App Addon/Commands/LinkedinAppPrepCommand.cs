...
{
    [Command(Name = "linkedinapp.prep", Tooltip = "This command displays questions to prepare for interview in Linkedin app")]

    public class LinkedinAppPrepCommand : Language.Command
    {
        public LinkedinAppPrepCommand(AbstractScripter scripter) : base(scripter)
        {
        }
        ...
        public void Execute(Arguments arguments)
        {
            ...
            arguments.By.Value = "xpath";
            ElementHelper.GetElement(arguments.By.Value, arguments.Search.Value).Click();
            arguments.Search.Value = "/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.ScrollView/android.widget.LinearLayout/androidx.recyclerview.widget.RecyclerView/android.widget.Button[4]";
            arguments.By.Value = "xpath";
            ElementHelper.GetElement(arguments.By.Value, arguments.Search.Value).Click();
        }
    }
