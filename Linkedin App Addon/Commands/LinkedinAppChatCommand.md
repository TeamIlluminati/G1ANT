...
This command displays the chats user has done in Linkedin app
...
This simple script opens a Linkedin application in user's android device and then open messages section in Linkedin app.
