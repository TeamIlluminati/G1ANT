...
{
    [Command(Name = "linkedinapp.appliedjobs", Tooltip = "This command displays user's applied jobs in Linkedin app")]

    public class LinkedinAppAppliedJobsCommand : Language.Command
    {
        public LinkedinAppAppliedJobsCommand(AbstractScripter scripter) : base(scripter)
        {
        }
