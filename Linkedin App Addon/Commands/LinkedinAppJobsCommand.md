...
This command displays jobs in Linkedin app according to user's profile
...
This simple script opens a Linkedin application in user's android device and then open Jobs section in Linkedin app.
