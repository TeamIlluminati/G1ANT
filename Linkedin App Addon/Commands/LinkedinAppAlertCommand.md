...
This command displays job alerts in Linkedin app
...
This simple script opens a Linkedin application in user's android device and then open Job Alerts section in Linkedin app.
