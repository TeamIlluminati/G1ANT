...
{
    [Command(Name = "linkedinapp.savedjobs", Tooltip = "This command displays user's saved jobs in Linkedin app")]

    public class LinkedinAppSavedJobsCommand : Language.Command
    {
        public LinkedinAppSavedJobsCommand(AbstractScripter scripter) : base(scripter)
        {
        }
