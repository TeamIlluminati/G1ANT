...
This command displays connections user has in Linkedin app
...
This simple script opens a Linkedin application in user's android device and then display user's Connections in Linkedin app.
