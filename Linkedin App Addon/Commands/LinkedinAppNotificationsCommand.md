...
This command displays user's notifications in Linkedin app
...
This simple script opens a Linkedin application in user's android device and then open Notifications section in Linkedin app.
