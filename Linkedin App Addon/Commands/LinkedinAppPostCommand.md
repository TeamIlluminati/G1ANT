...
| -------- | ---- | -------- | ------------- | ----------- |
|  `accesss`      | [text](https://manual.g1ant.com/link/G1ANT.Language/G1ANT.Language/Structures/TextStructure.md)   | yes |         | Provide accessbility-Anyone or Connections Only |
|   `text`        | [text](https://manual.g1ant.com/link/G1ANT.Language/G1ANT.Language/Structures/TextStructure.md)   | yes  |         |  Provide content of post   |
