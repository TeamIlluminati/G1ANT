...
This command display user's coupons in Flipkart app
...
This simple script opens a flipkart application and then logs into the account with provided credentials in app and then display user's notifications in it.
