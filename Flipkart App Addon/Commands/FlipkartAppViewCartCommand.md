...
This command display user's cart in FlipkartApp
...
This simple script opens a flipkart application and then logs into the account with provided credentials in app and then display user's cart in it.
