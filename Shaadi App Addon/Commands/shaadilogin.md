...
```G1ANT
shaadi.login login ⟦text⟧ pword ⟦text⟧
```

## Description


This command will login to the shaadi.com user account.
...
This simple script will login to the user shaadi.com account.

```G1ANT
shaadi.open
delay 10
shaadi.login login ‴test@gmail.com‴ pword ‴password‴
