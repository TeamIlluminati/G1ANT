...
{
    [Command(Name = "shaadi.com.open", Tooltip = "This command opens a new instance of a chosen web browser and opens the shaadi.com home page")]
    public class ShaadiOpenCommand : Command
    {
        public const string url = "https://www.shaadi.com/";
        ...
        public ShaadiOpenCommand(AbstractScripter scripter) : base(scripter)
        {
        }
