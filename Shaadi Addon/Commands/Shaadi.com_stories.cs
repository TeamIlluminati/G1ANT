...
{
    [Command(Name = "shaadi.com.stories", Tooltip = "This command opens th stories of the trending marriages")]
    public class ShaadireadstoriesCommand : Command
    {
        ...
        public ShaadireadstoriesCommand(AbstractScripter scripter) : base(scripter)
        {
        }
        public void Execute(Arguments arguments)
        {
            try
            {
                arguments.Search.Value = "/html/body/div[4]/div/div[3]/div/div[1]/div/div/div/p/a";
