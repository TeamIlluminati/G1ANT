...
{
    [Command(Name = "olaapp.open", Tooltip = "This command will open Ola App.")]
    public class OlaAppOpenCommand : Language.Command
    {
        ...
        public class Arguments : CommandArguments
        {
            ...
            public TextStructure AppActivity { get; set; } = new TextStructure("com.olacabs.customer.ui.MainActivity");

            [Argument(DefaultVariable = "app package", Tooltip = "App Package")]
            public TextStructure AppPackage { get; set; } = new TextStructure("com.olacabs.customer");
        ...
        public OlaAppOpenCommand(AbstractScripter scripter) : base(scripter)
        {
        }
