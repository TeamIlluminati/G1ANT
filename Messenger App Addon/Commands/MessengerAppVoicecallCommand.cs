...
{
    [Command(Name = "messengerapp.voicecall", Tooltip = "This command will voice call on Messenger App")]
    public class MessengerAppVoicecallCommand : Language.Command
    {
        ...
        public MessengerAppVoicecallCommand(AbstractScripter scripter) : base(scripter)
        {
        ...
        public void Execute(Arguments arguments)
        {
            ...
            arguments.Search.Value = "(//android.view.ViewGroup[@content-desc='Video chat'])[1]";
            arguments.By.Value = "xpath";
            ElementHelper.GetElement(arguments.By.Value.ToLower(), arguments.Search.Value).Click();
        }
    }
