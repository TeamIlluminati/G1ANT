...
```G1ANT
messengerapp.login email ⟦text⟧ pword ⟦text⟧
```

## Description

This command logins the user into messenger app.
...
This simple script opens a messenger application and then logs into the account with provided credentials in app.

```G1ANT
messengerapp.open
delay 8
messengerapp.login email <Enter your email here> pword <Enter your password>
```
