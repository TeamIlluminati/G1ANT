...
{
    [Command(Name = "messengerapp.open", Tooltip = "This command will open Messenger App.")]
    public class MessengerAppOpenCommand : Language.Command
    {
        ...
        public class Arguments : CommandArguments
        {
            ...
            public TextStructure AppActivity { get; set; } = new TextStructure("com.facebook.messenger.neue.MainActivity");
        ...
        public MessengerAppOpenCommand(AbstractScripter scripter) : base(scripter)
        {
        }
