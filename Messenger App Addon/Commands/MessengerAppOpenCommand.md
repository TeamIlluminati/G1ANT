...
```G1ANT
messengerapp.open devicename ⟦text⟧ platformname ⟦text⟧ platformversion ⟦text⟧
```

## Description

This command open messenger app in Android.
...
This simple script opens a messenger application in user's android device.
