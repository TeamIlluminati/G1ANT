...
{
    [Command(Name = "line.open", Tooltip = "Opens the interactive line portal")]
    class LineOpenCommand : Command
    {
        ...
        public class Arguments : LineCommandArguments
        {
            ...
            public TextStructure Url { get; set; } = new TextStructure("https://line.me/en/");
