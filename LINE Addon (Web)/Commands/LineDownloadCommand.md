...
This command ensures that Line is downloaded in a desktop or Android Phone. To download the file in the android phone, the phone name must be specified
...
The website launches in the defined web browser defined by the user. After which the application will install in the phone or desktop device to the path specified. 
