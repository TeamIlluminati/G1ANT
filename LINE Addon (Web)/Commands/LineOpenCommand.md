...
This command opens the line website in the user provided browser.
...
This simple script opens line  in chrome browser after waiting for 5 seconds .

```G1ANT
dialog message ‴Testing LINE‴
line.open type chrome
delay 5
line.close
```
