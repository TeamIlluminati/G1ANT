...
{
    [Command(Name = "uber.open", Tooltip = "This command opens a new instance of a chosen web browser and opens uber web page")]
    public class SeleniumOpenCommand : Command
    {
        public const string url = "https://www.uber.com/in/en/";
