...
{
    [Command(Name = "uber.pword", Tooltip = "This command types the password you have typed")]
    public class UberpwordCommand : Command
    {
        ...
        public UberpwordCommand(AbstractScripter scripter) : base(scripter)
        {
        }
