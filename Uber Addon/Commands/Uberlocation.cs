...
{
    [Command(Name = "uber.location", Tooltip = "This command types the location to where you want to travel")]
    public class UberlocationCommand : Command
    {
        public class Arguments : SeleniumCommandArguments
        {
            ...
            public TextStructure where { get; set; } = new TextStructure();
            [Argument(Required = true, Tooltip = "Enter the trend to be opened")]
            public TextStructure to { get; set; } = new TextStructure();
        
    }
        public UberlocationCommand(AbstractScripter scripter) : base(scripter)
        {
        }
        public void Execute(Arguments arguments)
        {
            try
            {
                ...
                SeleniumManager.CurrentWrapper.TypeText(arguments.where.Value, arguments, arguments.Timeout.Value);
