...
{
    [Command(Name = "uber.help", Tooltip = "This command opens the help web page")]
    public class UberhelpCommand : Command
    {
        ...
        public UberhelpCommand(AbstractScripter scripter) : base(scripter)
        {
        }
        public void Execute(Arguments arguments)
        {
            try
            {
                arguments.Search.Value = "/div/div/div[1]/div[5]/a";
