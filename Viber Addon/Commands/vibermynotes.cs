...
{
    [Command(Name = "viber.notes", Tooltip = "This command opens your notes")]
    public class MynotesCommand : Language.Command
    {
        ...
        public MynotesCommand(AbstractScripter scripter) : base(scripter)
        {
