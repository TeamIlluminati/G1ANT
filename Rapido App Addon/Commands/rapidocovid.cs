...
{
    [Command(Name = "rapido.covid", Tooltip = "This command opens covid page of rapido")]
    public class Covid19Command : Language.Command
    {
        ...
        public Covid19Command(AbstractScripter scripter) : base(scripter)
        {
