...
{
    [Command(Name = "rapido.myrides", Tooltip = "This command opens your rides")]
    public class MyridesCommand : Language.Command
    {
        ...
        public MyridesCommand(AbstractScripter scripter) : base(scripter)
        {
