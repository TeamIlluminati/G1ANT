...
{
    [Command(Name = "rapido.insurance", Tooltip = "This command insurance page")]
    public class InsuranceCommand : Language.Command
    {
        ...
        public InsuranceCommand(AbstractScripter scripter) : base(scripter)
        {
