...
{
    [Command(Name = "rapido.open", Tooltip = "This command initialises rapido.")]
    public class OpenCommand : Language.Command
    {
        ...
        public class Arguments : CommandArguments
        {
            ...
            public TextStructure AppActivity { get; set; } = new TextStructure("com.rapido.passenger.v2.ui.bfs.BFSItemsEntryActivity");

            [Argument(Required = true, Tooltip = "App Package")]
            public TextStructure AppPackage { get; set; } = new TextStructure("com.rapido.passenger");
