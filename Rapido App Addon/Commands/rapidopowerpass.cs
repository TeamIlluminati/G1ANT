...
{
    [Command(Name = "rapido.powerpass", Tooltip = "This command opens powerpass page")]
    public class PowerpassCommand : Language.Command
    {
        ...
        public PowerpassCommand(AbstractScripter scripter) : base(scripter)
        {
