...
{
    [Command(Name = "rapido.payment", Tooltip = "This command opens your payment method page")]
    public class PaymentCommand : Language.Command
    {
        ...
        public PaymentCommand(AbstractScripter scripter) : base(scripter)
        {
