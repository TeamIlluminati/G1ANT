...
This command allows the User to view their profile on Medium and be able to see if there are any changes to be made. 
...
2. After Successful authentication, the user is granted permission to login and will be taken to the place for viewing his profile.
3. Later on the robot will perform supplementary tasks that the User assigns the Robot. 
## Example

This script opens chrome browser and views the User's profile on Medium. 
