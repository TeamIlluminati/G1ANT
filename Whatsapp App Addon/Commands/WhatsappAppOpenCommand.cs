...
{
    [Command(Name = "whatsappapp.open", Tooltip = "This command will open Whatsapp App.")]
    public class WhatsappAppOpenCommand : Language.Command
    {
        ...
        public class Arguments : CommandArguments
        {
            ...
            public TextStructure AppActivity { get; set; } = new TextStructure("com.whatsapp.Main");

            [Argument(DefaultVariable = "app package", Tooltip = "App Package")]
            public TextStructure AppPackage { get; set; } = new TextStructure("com.whatsapp");
        ...
        public WhatsappAppOpenCommand(AbstractScripter scripter) : base(scripter)
        {
        }
