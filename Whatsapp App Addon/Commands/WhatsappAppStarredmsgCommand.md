...
This command displays starred messages in whatsapp app 
...
This simple script opens a whatsapp application in user's android device and then open starred messages section in whatsapp app.
