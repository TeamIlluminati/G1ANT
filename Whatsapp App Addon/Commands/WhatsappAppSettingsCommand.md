...
This command displays settings in whatsapp app 
...
This simple script opens a whatsapp application in user's android device and then open settings section in whatsapp app.
