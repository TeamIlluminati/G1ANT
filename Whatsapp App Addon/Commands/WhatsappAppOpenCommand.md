...
```G1ANT
whatsappapp.open devicename ⟦text⟧ platformname ⟦text⟧ platformversion ⟦text⟧
```

## Description

This command open whatsapp app in Android.
...
This simple script opens a whatsapp application in user's android device.
