...
This command displays web option in whatsapp app 
...
This simple script opens a whatsapp application in user's android device and then open web section in whatsapp app.
