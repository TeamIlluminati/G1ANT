...
This command displays status in whatsapp app 
...
This simple script opens a whatsapp application in user's android device and then open status section in whatsapp app.
