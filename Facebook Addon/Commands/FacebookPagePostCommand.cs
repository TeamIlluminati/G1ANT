...
{
    [Command(Name = "facebook.makepagepost", Tooltip = "This command makes a post to a page you admin.")]
    class FacebookMakePagePostCommand : Command
    {
        public FacebookMakePagePostCommand(AbstractScripter scripter) : base(scripter)
        {
        ...
        public class Arguments : CommandArguments
        {
            ...
            [Argument(Required = true, Tooltip = "Page ID")]
