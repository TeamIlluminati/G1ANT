...
{
    [Command(Name = "pinterestapp.open", Tooltip = "This command will open Pinterest App.")]
    public class OpenCommand : Language.Command
    {
        ...
        public class Arguments : CommandArguments
        {
            ...
            public TextStructure AppActivity { get; set; } = new TextStructure("com.pinterest.activity.task.activity.MainActivity");

            [Argument(DefaultVariable = "app package", Tooltip = "App Package")]
            public TextStructure AppPackage { get; set; } = new TextStructure("com.pinterest");
