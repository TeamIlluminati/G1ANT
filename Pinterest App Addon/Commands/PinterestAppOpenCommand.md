...
```G1ANT
pinterestapp.open devicename ⟦text⟧ platformname ⟦text⟧ platformversion ⟦text⟧
```

## Description

This command open pinterest app in Android.
...
This simple script opens a pinterest application in user's android device.
