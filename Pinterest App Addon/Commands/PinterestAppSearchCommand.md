...
This command will open search option on pinterest app
...
This simple script opens a pinterest application in user's android device and then open search option in pinterest app.
