...
This command will view user profile on pinterest app
...
This simple script opens a pinterest application in user's android device and then open user profile in pinterest app.
