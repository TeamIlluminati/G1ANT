...
This command will open saved pins on pinterest app
...
This simple script opens a pinterest application in user's android device and then open saved pins in pinterest app.
