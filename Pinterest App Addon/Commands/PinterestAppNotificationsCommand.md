...
This command will open notifications on pinterest app
...
This simple script opens a pinterest application in user's android device and then open notifications in pinterest app.
