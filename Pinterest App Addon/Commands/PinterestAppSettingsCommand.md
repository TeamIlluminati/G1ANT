...
This command will open settings on pinterest app
...
This simple script opens a pinterest application in user's android device and then open settings in pinterest app.
