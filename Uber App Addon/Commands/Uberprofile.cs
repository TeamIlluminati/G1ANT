...
{
    [Command(Name = "uber.profile", Tooltip = "This command opens profile window")]
    public class ProfileCommand : Language.Command
    {
        ...
        public ProfileCommand(AbstractScripter scripter) : base(scripter)
        {
