...
{
    [Command(Name = "uber.food", Tooltip = "This command opens food page")]
    public class FoodCommand : Language.Command
    {
        ...
        public FoodCommand(AbstractScripter scripter) : base(scripter)
        {
