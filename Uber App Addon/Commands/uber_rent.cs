...
{
    [Command(Name = "uber.rent", Tooltip = "This command opens rent page.")]
    public class RentCommand : Language.Command
    {
        ...
        public RentCommand(AbstractScripter scripter) : base(scripter)
        {
