...
{
    [Command(Name = "uber.help", Tooltip = "This command opens help page")]
    public class HelpCommand : Language.Command
    {
        ...
        public HelpCommand(AbstractScripter scripter) : base(scripter)
        {
