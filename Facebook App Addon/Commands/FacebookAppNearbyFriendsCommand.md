...
This command displays user's friends which are near user's location in Facebook app
...
This simple script opens a facebook application and then logs into the account with provided credentials and then open Nearby Friends section on Facebook app.
