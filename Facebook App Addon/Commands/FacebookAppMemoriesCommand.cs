...
{
    [Command(Name = "fbapp.memories", Tooltip = "This command displays user's memories in Facebook app")]

    public class FacebookAppMemoriesCommand : Language.Command
    {
        public FacebookAppMemoriesCommand(AbstractScripter scripter) : base(scripter)
        {
        }
