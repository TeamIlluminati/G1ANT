...
This command displays user's memories in Facebook app
...
This simple script opens a facebook application and then logs into the account with provided credentials and then open Memories section on Facebook app.
