...
{
    [Command(Name = "fbapp.pages", Tooltip = "This command displays user's pages in Facebook app")]

    public class FacebookAppPagesCommand : Language.Command
    {
        public FacebookAppPagesCommand(AbstractScripter scripter) : base(scripter)
        {
        }
