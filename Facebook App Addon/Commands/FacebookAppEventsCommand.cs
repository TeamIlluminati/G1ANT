...
{
    [Command(Name = "fbapp.events", Tooltip = "This command displays user's events in Facebook app")]

    public class FacebookAppEventsCommand : Language.Command
    {
        public FacebookAppEventsCommand(AbstractScripter scripter) : base(scripter)
        {
        }
