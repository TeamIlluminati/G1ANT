...
This command displays user's groups in Facebook app
...
This simple script opens a facebook application and then logs into the account with provided credentials and then open groups section on Facebook app.
