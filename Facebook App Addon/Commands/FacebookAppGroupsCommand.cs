...
{
    [Command(Name = "fbapp.groups", Tooltip = "This command displays user's groups in Facebook app")]

    public class FacebookAppGroupsCommand : Language.Command
    {
        public FacebookAppGroupsCommand(AbstractScripter scripter) : base(scripter)
        {
        }
