...
{
    [Command(Name = "fbapp.gaming", Tooltip = "This command displays games user can play in Facebook app")]

    public class FacebookAppGamingCommand : Language.Command
    {
        public FacebookAppGamingCommand(AbstractScripter scripter) : base(scripter)
        {
        }
