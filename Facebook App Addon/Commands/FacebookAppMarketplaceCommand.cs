...
{
    [Command(Name = "fbapp.marketplace", Tooltip = "This command displays marketplace in Facebook app")]

    public class FacebookAppMarketplaceCommand : Language.Command
    {
        public FacebookAppMarketplaceCommand(AbstractScripter scripter) : base(scripter)
        {
        }
