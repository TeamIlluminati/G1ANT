...
{
    [Command(Name = "fbapp.saved", Tooltip = "This command displays user's saved items in Facebook app")]

    public class FacebookAppSavedCommand : Language.Command
    {
        public FacebookAppSavedCommand(AbstractScripter scripter) : base(scripter)
        {
        }
