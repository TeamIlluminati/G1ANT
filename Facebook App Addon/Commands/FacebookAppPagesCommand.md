...
This command displays user's pages in Facebook app
...
This simple script opens a facebook application and then logs into the account with provided credentials and then open pages section in Facebook app.
