...
{
    [Command(Name = "fbapp.video", Tooltip = "This command displays user's videos in Facebook app")]

    public class FacebookAppVideosCommand : Language.Command
    {
        public FacebookAppVideosCommand(AbstractScripter scripter) : base(scripter)
        {
        }
