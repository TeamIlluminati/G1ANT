...
This simple script opens a facebook application and then logs into the account with provided credentials. Then after a delay of 8 seconds it will close the opened application.
