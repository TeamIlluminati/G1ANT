...
This command displays notifications in Facebook app
...
This simple script opens a facebook application and then logs into the account with provided credentials and then open Notifications in Facebook app.
