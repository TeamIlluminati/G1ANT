...
{
    [Command(Name = "ciscowebexandroid.open", Tooltip = "This command initialises appium server and opens CiscoWebEx Meetings in android application instance.")]
    public class CiscoWebExAndroidOpenCommand : Language.Command
    {
        ...
        public class Arguments : CommandArguments
        {
            ...
            public TextStructure AppPackage { get; set; } = new TextStructure("com.cisco.webex.meetings");

            [Argument(DefaultVariable = "app activity", Tooltip = "App Activity")]
            public TextStructure AppActivity { get; set; } = new TextStructure("com.cisco.webex.meetings.ui.premeeting.welcome.WebExMeeting");
        ...
        public CiscoWebExAndroidOpenCommand(AbstractScripter scripter) : base(scripter) 
        {
        }
