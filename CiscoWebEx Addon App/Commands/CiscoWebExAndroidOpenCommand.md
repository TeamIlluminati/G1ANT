...
This command opens WebEx in user's android device.
...
With the android device being connected and configured, based on the app activity and app package defined, WebEx opens on the user's device and would be ready for using in phone. 

## Example

This simple script opens webEx application in android devices. 

```G1ANT
dialog message ‴Opening CiscoWebEx Android Application‴
ciscowebexandroid.open
delay 5
