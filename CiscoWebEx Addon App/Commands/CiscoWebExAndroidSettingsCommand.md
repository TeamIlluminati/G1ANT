...
This command allows the users to open their settings on WebEx Applications
...
1. The user opens the android instance and logs into the application.
2. After logging in, the robot opens the settings option for the user to see more on the options available for customizing the devices and accounts. 

## Example

This simple script allows users to see their settings on WebEx Application for the device. 
