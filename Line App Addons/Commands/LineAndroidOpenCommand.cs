...
{
    [Command(Name = "lineandroid.open", Tooltip = "This command initialises appium server and opens Line in android application instance.")]
    public class LineAndroidOpenCommand : Language.Command
    {
        ...
        public class Arguments : CommandArguments
        {
            ...
            public TextStructure AppPackage { get; set; } = new TextStructure("jp.naver.line.android");

            [Argument(DefaultVariable = "app activity", Tooltip = "App Activity")]
            public TextStructure AppActivity { get; set; } = new TextStructure("jp.naver.line.android.activity.SplashActivity");
        ...
        public LineAndroidOpenCommand(AbstractScripter scripter) : base(scripter) 
        {
        }
