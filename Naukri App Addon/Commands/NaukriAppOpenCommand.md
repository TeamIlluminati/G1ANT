...
```G1ANT
naukriapp.open devicename ⟦text⟧ platformname ⟦text⟧ platformversion ⟦text⟧
```

## Description

This command open Naukri.com app in user's Android device.
...
This simple script opens a naukri.com application in user's android device.
