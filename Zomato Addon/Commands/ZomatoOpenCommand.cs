...
{
    [Command(Name = "zomato.open", Tooltip = "This command will open zomato")]
    class ZomatoOpenCommand : Command
    {
        public ZomatoOpenCommand(AbstractScripter scripter) : base(scripter)
        {
