...
{
    [Command(Name = "zomato.settings", Tooltip = "This command will open settings on zomato")]
    class ZomatoSettingsCommand : Command
    {
        public ZomatoSettingsCommand(AbstractScripter scripter) : base(scripter)
        {
