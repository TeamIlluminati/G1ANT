...
```G1ANT
swiggyapp.open devicename ⟦text⟧ platformname ⟦text⟧ platformversion ⟦text⟧
```

## Description

This command open Swiggy app in user's Android device.
...
This simple script opens a Swiggy application in user's android device.
