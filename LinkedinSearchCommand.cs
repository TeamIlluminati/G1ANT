...
{
    [Command(Name = "linkedin.search", Tooltip = "This command is used to search on the linkedin site.")]
    public class LinkedinSearchCommand : Command
    {
        public LinkedinSearchCommand(AbstractScripter scripter) : base(scripter)
        {
