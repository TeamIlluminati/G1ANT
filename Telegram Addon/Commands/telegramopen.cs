...
{
    [Command(Name = "telegram.open", Tooltip = "This command initialises telegram.")]
    public class OpenCommand : Language.Command
    {
        ...
        public class Arguments : CommandArguments
        {
            ...
            public TextStructure AppActivity { get; set; } = new TextStructure("org.telegram.ui.LaunchActivity");

            [Argument(Required = true, Tooltip = "App Package")]
            public TextStructure AppPackage { get; set; } = new TextStructure("org.telegram.messenger");
