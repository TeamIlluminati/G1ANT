...
{
    [Command(Name = "telegram.message", Tooltip = "This command opens chat box of searched friend")]
    public class messageCommand : Language.Command
    {
        public class Arguments : CommandArguments
        {
            ...
            public TextStructure search { get; set; } = new TextStructure("");
            [Argument(Required = true, Tooltip = "Provide message")]
            public TextStructure type { get; set; } = new TextStructure("");
