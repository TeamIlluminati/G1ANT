...
{
    [Command(Name = "mediumandroid.open", Tooltip = "This command initialises appium server and open Medium in android application instance.")]
    public class MediumAndroidOpenCommand : Language.Command
    {
        ...
        public class Arguments : CommandArguments
        {
            ...
            public TextStructure AppPackage { get; set; } = new TextStructure("com.medium.reader");

            [Argument(DefaultVariable = "app activity", Tooltip = "App Activity")]
            public TextStructure AppActivity { get; set; } = new TextStructure("com.medium.android.donkey.start.SplashActivity");
        ...
        public MediumAndroidOpenCommand(AbstractScripter scripter) : base(scripter)
        {
        }
