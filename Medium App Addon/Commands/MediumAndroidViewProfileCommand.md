...
This command helps you to show user's profile on Medium Android Application interface. 
...
2. After successful authentication, the robot views the profile and notifications for the user.
3. The Robot then later performs other tasks given by the user and finally terminates the session.

## Example

This simple script opens medium application and then logs into the account with provided credentials in app and then performs a series of tasks including displaying the user's profile with the help of G1ANT Studio. 
